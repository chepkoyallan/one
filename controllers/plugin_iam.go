...
func (aws *AwsIAMForServiceAccount) ApplyPlugin(r *ProfileReconciler, profile *icodeaiv1.Profile) error {
...
func (aws *AwsIAMForServiceAccount) RevokePlugin(r *ProfileReconciler, profile *icodeaiv1.Profile) error {
	logger := r.Log.WithValues("profile", profile.Name)
